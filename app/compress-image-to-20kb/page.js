export const metadata = {
  title: 'Compress Image to 20KB Online Free | Rakib bae',
  description: 'Instantly compress your image to 20KB or less without losing quality. 100% Free online tool, no login required. Perfect for job applications and forms.',
  keywords: 'compress image to 20kb, reduce image size to 20kb, 20kb image compressor, resize photo to 20kb',
};
    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4 bg-slate-900">
      <div className="bg-slate-800/50 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-slate-700 max-w-2xl w-full text-center">
        ...
        <p className="text-slate-300 mb-6 text-lg">
          ...
          Use our AI tool to perfectly reduce your image size to exactly 20KB without losing quality!
        </p>
